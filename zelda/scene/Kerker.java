 ...
 * @author Christiaan
 */
public class Kerker extends ZeldaScene {

    Polygon muur, muur1, tafel;

    public Kerker(Game game, String entrance) {
        super(game, "images/kerker.png", entrance);
        ...
        muur = new Polygon(dxpos, dypos, dypos.length);
        ...
        muur1 = new Polygon(expos, eypos, eypos.length);

        int[] fxpos = {129, 129, 159, 160, 130};
        int[] fypos = {228, 252, 252, 229, 227};

        tafel = new Polygon(fxpos, fypos, fypos.length);
